...
# Process digitised logbook data from Bear into
#  IMMA records.
...
foreach my $Year (1884,1886,1887,1888,1890,1891,1892,1893,1894,
                  1895,1896,1897,1898,1901,1902,1903,1904,1905,
                  1906,1907,1908,1909,1910,1911,1912,1918) {
    ...
    open(DOUT,sprintf ">imma.annual/Bear.%04d.imma",$Year) or die;
    for(my $i=0;$i<scalar(@Imma);$i++) {
	$Imma[$i]->write(\*DOUT);
    }
    close(DOUT);
