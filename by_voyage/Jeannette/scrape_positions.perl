...
my $nhn=`curl http://www.naval-history.net/OW-US/Jeannette/USS_Jeannette-1879-1880.htm`;
$nhn =~ s/\n/ /gm; # strip newlines
my @nhn = split /\<\/p\>/,$nhn; # split on paragraphs
$nhn = `curl http://www.naval-history.net/OW-US/Jeannette/USS_Jeannette-1880-1881.htm`;
$nhn =~ s/\n/ /gm;
push @nhn, split /\<\/p\>/,$nhn;
