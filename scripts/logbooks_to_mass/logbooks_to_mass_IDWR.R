# Transfer station images from US-scanned IDWR to MO MASS system

ArchiveDir <- 'moose:/adhoc/users/philip.brohan/station_images/Indian_Daily_Weather_Reports_MO/'
SourceDir <- '/scratch/hadpb/Indian_Daily_Weather_Reports_MO'
