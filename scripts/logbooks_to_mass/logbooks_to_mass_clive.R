...
ArchiveDir <- 'moose:/adhoc/users/philip.brohan/logbook_images/Chilean_logbooks'
SourceDir <- '/scratch/hadpb/logbook_images/2017_06_Met_Office_Image_Delivery/Chilean_logbooks'
