...
ArchiveDir <- 'moose:/adhoc/users/philip.brohan/logbook_images/Clive_National_Meteorological_Archive/Arctic_logs_2018_08'
SourceDir <- '/scratch/hadpb/logbook_images/2018_08_Met_Office_Delivery/NMA_Arctic'
