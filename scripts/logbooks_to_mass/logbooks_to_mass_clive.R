...
ArchiveDir <- 'moose:/adhoc/users/philip.brohan/logbook_images/Clive_National_Meteorological_Archive/NMA_Pacific_2022_06/'
SourceDir <- '/scratch/hadpb/tmp/NMA_Pacific_2022_06/'
