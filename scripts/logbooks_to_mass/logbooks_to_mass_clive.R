...
ArchiveDir <- 'moose:/adhoc/users/philip.brohan/logbook_images/Clive_TNA/China_Logs_2017_02_TNA_Batch2'
SourceDir <- '/scratch/hadpb/logbook_images/China_Logs_2017_02_TNA_Batch2'
