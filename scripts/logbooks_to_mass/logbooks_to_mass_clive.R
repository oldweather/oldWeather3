...
ArchiveDir <- 'moose:/adhoc/users/philip.brohan/logbook_images/Clive_National_Meteorological_Archive/NMA_Pacific_2021_Dec/'
SourceDir <- '/scratch/hadpb/logbook_images/NMA_Pacific_2021_Dec/'
